...
sns.distplot(COM_x, rug=False, hist=False, color='orange')
...
sns.distplot(COM_y, rug=False, hist=False, vertical=True, color='orange')

# the scatter plot:
for i in range(length):
    ax_scatter.plot(int(COM_smooth[i][0]),int(COM_smooth[i][1]),color='orange', marker='.') 
